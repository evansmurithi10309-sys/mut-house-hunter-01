...
// Record visiting fee payment WITHOUT marking occupied automatically
function recordVisitingFeePayment(houseId, userPhone, mpesaRef, smsTimestamp) {
  try {
    ...
    // NOTE: Per user request, payment does NOT automatically mark house as occupied!
    // Availability is strictly controlled by the developer via the Developer Portal.
